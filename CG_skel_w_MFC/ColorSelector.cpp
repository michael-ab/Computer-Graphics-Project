...
scolor ColorSelector::GetColor()
{
	COLORREF clr = m_colorWidget.GetColor();
	return scolor(((float)GetRValue(clr)/255), ((float)GetGValue(clr)/255), ((float)GetBValue(clr)/255));
}

void ColorSelector::SetColor(scolor clr)
{
